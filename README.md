...
git clone https://github.com/zynomon/e.sh
cd e.sh
bash e.sh
```
...
# You have to execute this twice in a row 1. before installing ( live system )  2 . after installing ( base/normal system )
